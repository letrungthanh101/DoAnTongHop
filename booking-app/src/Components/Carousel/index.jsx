...
function Slide(props) {
  ...
  const recommendItem = [
    { id: 1, images: Images.img_LiemBarber ,title: 'Liêm Barbershop', description:'Defining men style, great experience in a Chicano atmosphere'},
    { id: 2, images: Images.img_LiemBarber ,title: '30Shine', description:'3 core values at 30Shine: Honesty, Ham to learn and Happy to serve'},
    { id: 3, images: Images.img_LiemBarber ,title: 'Barbershop Vũ trí', description:'Good Quality creates Strong Brand men style, great experience in a Chicano atmosphere'},
    { id: 4, images: Images.img_LiemBarber ,title: 'Barbershop 4Rau', description:'Giving customers a great experience in a classic style space'},
  ]
