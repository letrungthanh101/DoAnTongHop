    ...
    <div className="container-fluid ">
      <section className="booking">
        <div className="row d-flex justify-content-center booking--row ">
          <div className="col-md-6 col-12 col-lg-5 col-sm-8 ">
              ...
              <div className={classes.paper}>
                ...
                <form className={classes.form} noValidate>
                  <TextField
                    ...
                    autoFocus
                  />
                 <Select className={classes.select} defaultValue="Quận 1" onChange={handleOnChange} variant="outlined" fullWidth  margin="normal" autoFocus >
